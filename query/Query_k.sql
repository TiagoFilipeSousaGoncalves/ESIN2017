--ESIN FINAL PROJECT
/*k. A list of pairs of contractors that were hired for common projects and 
the average difference between the expected and true duration of those projects.*/

SELECT project_name AS [Project Name], contrator1.ctr_name AS [Contractor 1 Name], contrator2.ctr_name AS [Contractor 2 Name], AVG (pex_duration-ptrue_duration) AS [Average Difference]
...
GROUP BY project_name, contrator1.ctr_name, contrator2.ctr_name